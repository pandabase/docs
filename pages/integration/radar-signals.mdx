...
# Radar Signals Overview

Radar Signals provides an extra level of protection for your shops. While
Pandabase Chargeback Protection isn't provided free of charge, Pandabase Radar
Signals is offered for free to all users. Fraud Shield helps you fight disputes
that are not legitimate.

### Enabling

Radar Signals is enabled by default for all shops free of charge. Radar Signals
...
please upgrade your shop to the "Pro" plan and disable it.

### Supported Payment Methods

Pandabase Radar Signals currently only covers card and PayPal payments. We are
looking forward to expanding to other providers.
