...
| ------------- | ------------------- | --------------------- | --------------------------------- |
| One Time      | Available now       | Single purchase items | Lifetime access to a software     |
| Service       | Available now       | Sellable services     | Consulting or design work         |
| Downloads     | Available now       | Downloadable files    | Screen recording software         |
| Serial Keys   | Available now       | Unique access codes   | Discord bot access key            |
| License       | Available now       | Software licenses     | App licenses managed via API      |
| Subscriptions | Coming in Q4 2024   | Recurring payments    | Monthly access to a service       |
| Physical      | Planned for Q4 2026 | Tangible products     | T-shirts or merchandise (US only) |
